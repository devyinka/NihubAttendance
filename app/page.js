...
export default function Home() {
  ...
  return (
    <div className="bg-white">
      ...
      <div className="text-[#7741c3] text-center font-mono text-xs font-normal justify-center  absolute bg-white place-self-center w-[80%] flex flex-wrap flex-col lg:mt-0 lg:pt-8  ">
        <h1 className="text-sm font-bold md:text-2xl lg:text-3xl   lg:mt-[-24px] lg:pb-6">
          Available Events
        </h1>
